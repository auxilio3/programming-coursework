...
public class EnumDemo {
	...
	public static void main(String[] args) {
		...
		//The following statement displays the ordinal value for Day.SUNDAY which is 0
		System.out.println("The ordinal value for " + Day.SUNDAY + " is " + Day.SUNDAY.ordinal());
		
		//The following statement displays the ordinal value for Day.SATURDAY which is 6
